...
aws.config.update({
    ...
    var imap = new Imap({
        user: 'kaijiu1013@gmail.com', // 邮箱账号
        password: 'Liusiyuan1013', //邮箱密码
...
async function getPdfData (fileName) {
    const params = {
        DocumentLocation: { 
            ...
            FeatureTypes: ["FORMS"],
            NotificationChannel: {
                SNSTopicArn: "arn:aws:sns:us-west-2:388942337280:textract",
                RoleArn: "arn:aws:iam::388942337280:role/SNS-admin",
            },
        }
    ...
    const queueUrl = 'https://sqs.us-west-2.amazonaws.com/388942337280/textract'
    ...
    .then(async (data) =>{
        if(data) {
            ...
            const params_2 = {
                JobId:"8ffe45e590ba08eafa5e30f374fce6ca1eaeee57a8e428e889f049edaf97d8ec"
            };
